...
@Component({
  ...
  templateUrl: './training-battalion.component.html',
  styleUrls: ['./training-battalion.component.scss','../common-style/common-style.scss']
})
export class TrainingBattalionComponent implements OnInit {
  ...
  getStaffList(){
    ...
    this.delayDashboardService.getStaffList(2,this.termId).subscribe(
      res=>{
        console.log(res);
          if(res.status == "OK"){
            if(res.object){
