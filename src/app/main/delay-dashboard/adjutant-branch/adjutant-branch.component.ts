...
@Component({
  ...
  templateUrl: './adjutant-branch.component.html',
  styleUrls: ['./adjutant-branch.component.scss','../common-style/common-style.scss']
})
export class AdjutantBranchComponent implements OnInit {
  ...
  getStaffList(){
    ...
    this.delayDashboardService.getStaffList(12,this.termId).subscribe(
      res=>{
        console.log(res);
          if(res.status == "OK"){
            if(res.object){
