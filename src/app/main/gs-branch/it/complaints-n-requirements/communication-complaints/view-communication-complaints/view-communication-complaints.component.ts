...
export class ViewCommunicationComplaintsComponent implements OnInit {
  ...
  goBack() {
    if (this.router.url.includes('main/GS-Branch'))
      this.router.navigate(['/main/GS-Branch/it/complaints-requirements/communication'])
    if (this.router.url.includes('main/admin'))
      this.router.navigate(['/main/admin/GS-Branch/it/complaints-requirements/communication'])
  }
