...
@Component({
  ...
  templateUrl: './it-complaints.component.html',
  styleUrls: ['./it-complaints.component.scss']
})
export class ItComplaintsComponent implements OnInit {

  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
  dataSource: any;
  displayedColumns: string[] = ['number','title','name','department','address','requestType','document','requestStatus','action'];  
  Complaints: any[] = [];
