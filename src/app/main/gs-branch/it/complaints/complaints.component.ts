...
export class ComplaintsComponent implements OnInit {
  ...
  dataSource: any;
  displayedColumns: string[] = ['number','title','name','department','address','requestType','requestNature','document','requestStatus','action'];  
  Complaints: any[] = [];
...
console.log(res,"=================");
  ...
  addComplaints() {
    this.router.navigate(['/main/gs-branch/it/complaints/add-complaints']);
  }
