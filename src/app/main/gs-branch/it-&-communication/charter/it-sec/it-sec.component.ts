...
@Component({
  selector: 'ms-it-sec',
  templateUrl: './it-sec.component.html',
  styleUrls: ['./it-sec.component.scss']
})
export class ItSecComponent implements OnInit {
  ...
  getItSec(){
    this.spinner.show();
  this.adminservice.getiTSec(2).subscribe(res =>{  
    console.log(res);
...
console.log(res,"=================");
  ...
  addITSEC() {
    this.router.navigate(['/main/gs-branch/itcommunication/charter/it-sec/add-it-sec']);
  }
  ...
  viewITSEC(element) {
    ...
    this.router.navigate(['/main/gs-branch/itcommunication/charter/it-sec/view-it-sec'],{queryParams:{id:element.id}})
    ...
    this.dialog.open(DialogComponent,
      {
        ...
        data: {
          type: 'document',title:"ITSEC Document", url: e.file
        }
      }
      )
    }
