...
console.log(res,"=================");
  ...
  addSRE() {
    this.router.navigate(['/main/gs-branch/security/apparatus/sre/add-sre']);
  }
  ...
  viewSRE(element) {
    ...
    this.router.navigate(['/main/gs-branch/security/apparatus/sre/view-sre'],{queryParams:{id:element.id}})
