...
export class CombatComponent implements OnInit {
  ...
  getCOMBAT(){
    this.spinner.show();
  this.adminservice.getCOMBAT(2).subscribe(res =>{  
    console.log(res);
...
console.log(res,"=================");
  ...
  addCombat() {
    this.router.navigate(['main/gs-branch/security/access-control/entry-passes/combat/add-combat']);
  }
  ...
  viewCombat(element) {
    this.router.navigate(['main/gs-branch/security/access-control/entry-passes/combat/view-combat'],{queryParams:{id:element.id}})  

    if(this.router.url.includes('main/gs-branch'))
    this.router.navigate(['main/gs-branch/security/access-control/entry-passes/combat/view-combat'],{queryParams:{id:element.id}})
    // if(this.router.url.includes('main/admin'))
    // this.router.navigate(['main/admin/GS-Branch/security/access-control/entry-passes/combat/view-combat'],{queryParams:{id:element.id}})  
  }
  ...
  openDoc(e){
    ...
    this.dialog.open(DialogComponent,
      {
        ...
        data: {
          type: 'document',title:"Combat Document", url: e.file
        }
      }
      )
    }
    ...
    changeCOMBATStatus(e, d) {
      this.spinner.show();
      if (e.checked) {
        this.adminservice.changeCOMBATStatus(d.id, 1).subscribe(
          res => {
            console.log(res);
        ...
        this.adminservice.changeCOMBATStatus(d.id, 0).subscribe(
          res => {
            console.log(res);
