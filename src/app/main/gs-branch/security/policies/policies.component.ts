...
console.log(res,"=================");
  ...
  openDoc(e){
    ...
    changePoliciesStatus(e, d) {
      this.spinner.show();
      if (e.checked) {
        this.adminservice.changePoliciesStatus(d.id, 1).subscribe(
          res => {
            console.log(res);
        ...
        this.adminservice.changePoliciesStatus(d.id, 0).subscribe(
          res => {
            console.log(res);
