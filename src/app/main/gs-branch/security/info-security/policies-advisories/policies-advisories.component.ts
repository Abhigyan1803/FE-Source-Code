...
console.log(res,"=================");
  ...
  addAdvisories() {
    this.router.navigate(['/main/gs-branch/security/info-security/policies/add-policies']);
  }
  ...
  viewAdvisories(element) {
    ...
    this.router.navigate(['main/gs-branch/security/info-security/policies/view-policies'],{queryParams:{id:element.id}})
    ...
    this.dialog.open(DialogComponent,
      {
        ...
        data: {
          type: 'document',title:"Policies Document", url: e.file
        }
      }
      )
    }
