...
@Component({
  selector: 'ms-prophylactic-reports',
  templateUrl: './prophylactic-reports.component.html',
  styleUrls: ['./prophylactic-reports.component.scss']
})
export class ProphylacticReportsComponent implements OnInit {
  ...
  getProphylactic(){
    this.spinner.show();
  this.adminservice.getProphylactic(2).subscribe(res =>{  
    console.log(res);
...
console.log(res,"=================");
  ...
  addProphyactic() {
    this.router.navigate(['main/gs-branch/security/prophylactic/prophylactic-reports/add-prophylactic-reports']);
  }
  ...
  viewProphyacticReport(element) {
    if(this.router.url.includes('main/gs-branch'))
    this.router.navigate(['main/gs-branch/security/prophylactic/prophylactic-reports/view-prophylactic-reports'],{queryParams:{id:element.id}})
    // if(this.router.url.includes('main/admin'))
    // this.router.navigate(['main/admin/GS-Branch/security/prophylactic/prophylactic-reports/view-prophylactic-reports'],{queryParams:{id:element.id}})  
  }
