...
@Component({
  ...
  templateUrl: './leaderly.component.html',
  styleUrls: ['./leaderly.component.scss']
})
export class LeaderlyComponent implements OnInit {
  ...
  getSyllabusList() {
    this.spinner.show()
    this.service.getSyllabusList('Leaderly',this.termId,2).subscribe(
      res => {
        if (res.status == "OK") {
