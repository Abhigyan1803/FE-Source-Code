...
@Component({
  ...
  templateUrl: './add-bmt2final.component.html',
  styleUrls: ['./add-bmt2final.component.scss']
})
export class AddBmt2finalComponent implements OnInit {
  ...
  constructor(
    ...
    this.runbackForm = this.fb.group({
      ...
      subjectType: ['BMT-2', Validators.required,],
      totalMarks: ['150', Validators.required,],
