...
export class RetestComponent implements OnInit {
  ...
  constructor(private router: Router, private route:ActivatedRoute ,private adminservice: AdminService, private spinner:NgxSpinnerService,
    ...
    getPOC(BMT2Retest){
      this.spinner.show();
    this.adminservice.getRetestLIST(BMT2Retest).subscribe(res =>{  
      console.log(res);
    ...
    addNominal() {
      this.router.navigate(['main/trg-team/gso-2-assessment/'+this.term+'/service-subjects/Bmt2/retest/add-retest']);
    }
    ...
    viewretest(id) {
      this.router.navigate(['main/trg-team/gso-2-assessment/'+this.term+'/service-subjects/Bmt2/retest/view-retest'],{queryParams:{id:id}})  
