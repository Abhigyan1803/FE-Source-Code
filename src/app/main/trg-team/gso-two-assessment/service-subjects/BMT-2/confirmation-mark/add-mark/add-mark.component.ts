...
export class AddMarkComponent implements OnInit {
      ...
      this.route.params.subscribe(
        (params)=>{
          ...
          this.addNominalForm = this.fb.group({
            ...
            studyMaterialType:['BMT2Confirmation'],
            doc: []
          })
  ...
  goBack(){
    this.router.navigate(['/main/trg-team/gso-2-assessment/'+this.term+'/service-subjects/Bmt2/confirmation-mark']); 
  }
}
