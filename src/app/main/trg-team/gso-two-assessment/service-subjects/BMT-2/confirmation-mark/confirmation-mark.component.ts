...
@Component({
  selector: 'ms-confirmation-mark',
  templateUrl: './confirmation-mark.component.html',
  styleUrls: ['./confirmation-mark.component.scss']
})
export class ConfirmationMarkComponent implements OnInit {
  ...
  constructor(private router: Router, private route:ActivatedRoute ,private adminservice: AdminService, private spinner:NgxSpinnerService,
    ...
    ngAfterViewInit() {
      this.getPOC('BMT2Confirmation')
    }
    
    
    
    getPOC(BMT2Confirmation){
      this.spinner.show();
    this.adminservice.getConfirmationLIST2(BMT2Confirmation).subscribe(res =>{  
      console.log(res);
    ...
    addNominal() {
      this.router.navigate(['main/trg-team/gso-2-assessment/'+this.term+'/service-subjects/Bmt2/confirmation-mark/add-mark']);
    }
    ...
    viewMark(id) {
      this.router.navigate(['main/trg-team/gso-2-assessment/'+this.term+'/service-subjects/Bmt2/confirmation-mark/view-mark'],{queryParams:{id:id}})  
    ...
    openDoc(e){
      ...
      changePOCStatus(e, d) {
        ...
        if (e.checked) {
          ...
          this.adminservice.changePOCStatus(d.id, 0).subscribe(
            res => {
              console.log(res);
