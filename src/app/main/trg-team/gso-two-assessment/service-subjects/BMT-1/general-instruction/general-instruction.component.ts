...
export class GeneralInstructionComponent implements OnInit {
  ...
  constructor(private router: Router, private route:ActivatedRoute, private adminservice: AdminService, private spinner:NgxSpinnerService,
    ...
    ngAfterViewInit() {
      this.getPOC('GeneralInstruction')
    }
    ...
    addNominal() {
      this.router.navigate(['main/trg-team/gso-2-assessment/'+this.term+'/service-subjects/Bmt1/general-instruction/add-instruction']);
    }
    ...
    view(id) {
      this.router.navigate(['main/trg-team/gso-2-assessment/'+this.term+'/service-subjects/Bmt1/general-instruction/view-instruction'],{queryParams:{id:id}})  
    }
