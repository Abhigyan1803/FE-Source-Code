...
@Component({
  ...
  templateUrl: './oq-marks.component.html',
  styleUrls: ['./oq-marks.component.scss']
})
export class OQMarksComponent implements OnInit {

  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;

  dataSource: any;
  displayedColumns: string[] = ['number', 'subjectName','plTotalMarks','coyTotalMarks','bnTotalMarks','status','action'];  
  POC: any[] = [];
  ...
  getSubject(){
    this.spinner.show();
  this.adminservice.getSubject(2).subscribe(res =>{  
    console.log(res);
