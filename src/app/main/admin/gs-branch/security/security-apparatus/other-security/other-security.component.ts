...
console.log(res,"=================");
  ...
  addOtherSecurity() {
    this.router.navigate(['/main/admin/GS-Branch/security/apparatus/other-security/add-other-security']);
  }
  ...
  viewOtherSecurity(element) {
    ...
    this.router.navigate(['/main/admin/GS-Branch/security/apparatus/other-security/view-other-security'],{queryParams:{id:element.id}})
