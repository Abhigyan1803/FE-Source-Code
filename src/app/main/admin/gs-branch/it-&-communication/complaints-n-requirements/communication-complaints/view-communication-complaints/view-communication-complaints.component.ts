...
@Component({
  ...
  templateUrl: './view-communication-complaints.component.html',
  styleUrls: ['./view-communication-complaints.component.scss']
})
export class ViewCommunicationComplaintsComponent implements OnInit {

  unSelectedFile: any;
  pageTitle = "View Complaint/Request";
  battalions:any[]=[];
  descLength:number = 0;
      ...
      this.adminservice.getComplaintsByID(this.id).subscribe(
        res => {
          ...
          if (res.status == 'OK') {
            ...
            this.RemarksLength = res.object.remarks.length;
  ...
  goBack() {
    if (this.router.url.includes('main/gs-branch'))
      this.router.navigate(['/main/gs-branch/GS-Branch/itcommunication/complaints-requirements/communication'])
    if (this.router.url.includes('main/admin'))
      this.router.navigate(['main/admin/GS-Branch/itcommunication/complaints-requirements/communication'])
  }
