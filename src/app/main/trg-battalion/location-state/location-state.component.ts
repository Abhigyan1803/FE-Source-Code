...
export class LocationStateComponent implements OnInit {
  ...
  addLocationState() {
    ...
    if (this.router.url.includes('main/admin'))
      this.router.navigate(['/main/admin/trg-battalion/location-state/add-locationstate']);
  }
  ...
  editLocationState(ob) {
    ...
    if (this.router.url.includes('admin'))
      this.router.navigate(['/main/admin/trg-battalion/location-state/view-locationstate'], { queryParams: { id: ob.id } });
  }
