...
@Component({
  selector: 'ms-oq-mid',
  templateUrl: './oq-mid.component.html',
  styleUrls: ['./oq-mid.component.scss']
})
export class OqMidComponent implements OnInit {
  ...
  getSpecialAllList() {
    this._trgBattalion.getOQ_All_ListByBCNameComp(this.termId, this.currentPage, this.pageSize, this.battalionName).subscribe(res => {
      console.log(res);
      if (res.message == 'OK') {
    ...
    if (this.serviceid == null || this.serviceid == undefined || this.serviceid == '') {
      ...
      merge(/* this.sort.sortChange,  */this.paginator.page)
        .pipe(
          ...
          switchMap(() => {
            this.spinner.show()
            return this._trgBattalion.getOQ_Marks_list_search(this.termId, this.serviceid, this.paginator.pageIndex, this.paginator.pageSize)
          }), map(data => {
  ...
  getOQMarksAlllist() {
    this.spinner.show();
    if (this.battalionId == 1 || this.battalionId == 2 || this.battalionId == 3 || this.battalionId == 4) {
      this._trgBattalion.getOQ_Marks_All_ListByBCName(this.termId, this.currentPage, this.pageSize, this.battalionName, this.companyName).subscribe(res => {
        console.log(res);
      ...
      this._trgBattalion.getOQ_Marks_list(this.termId, 1, this.currentPage, this.pageSize).subscribe(res => {
        console.log(res);
        if (res.message == 'Record not found') {
          this.spinner.hide();
          this._trgBattalion.openSnackbar(res.message);
