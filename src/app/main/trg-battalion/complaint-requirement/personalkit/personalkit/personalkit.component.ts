...
@Component({
  selector: 'ms-personalkit',
  templateUrl: './personalkit.component.html',
  styleUrls: ['./personalkit.component.scss']
})
export class PersonalkitComponent implements OnInit {

 
  type: string = "Personal Kit Items";
