...
@Component({
  selector: 'ms-add-goi',
  templateUrl: './add-goi.component.html',
  styleUrls: ['./add-goi.component.scss']
})
export class AddGoiComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.router.url.includes('add-goi')) {
      this.pageTitle = 'Add Achievements'
    }
    else if (this.router.url.includes('view-goi')) {
      this.spinner.show()
  ...
  goBack() {
    this.router.navigate(['main/academic-depart/examination/goi']);
  }
