...
@Component({
  selector: 'ms-counsellors-meiktila',
  templateUrl: './counsellors-meiktila.component.html',
  styleUrls: ['./counsellors-meiktila.component.scss']
})
export class CounsellorsMeiktilaComponent implements OnInit {
...
console.log(res,"=================");
  ...
  addMEIKTILA() {
    this.router.navigate(['/main/academic-depart/counsellors/thbn/counsellors-meiktila/add-meiktila']);
  }
  ...
  viewMEIKTILA(element) {
    if(this.router.url.includes('main/academic-depart'))
    this.router.navigate(['/main/academic-depart/counsellors/thbn/counsellors-meiktila/view-meiktila'],{queryParams:{id:element.id}})
  ...
  sortData(sort: Sort){
    ...
    const datalist = this.Meiktila.slice();
    if (!sort.active || sort.direction === '') {
      this.Meiktila = datalist;
      return;
    }
    this.Meiktila = datalist.sort((a: any, b: any) => {
    ...
    this.dataSource = new MatTableDataSource(this.Meiktila);
    this.dataSource.paginator = this.paginator;
    if (this.dataSource.paginator) {
      this.dataSource.paginator.firstPage();
    }
