...
@Component({
  selector: 'ms-counsellors-cassino',
  templateUrl: './counsellors-cassino.component.html',
  styleUrls: ['./counsellors-cassino.component.scss']
})
export class CounsellorsCassinoComponent implements OnInit {
...
console.log(res,"=================");
  ...
  addCASSINO() {
    this.router.navigate(['/main/academic-depart/counsellors/bhbn/counsellors-cassino/add-cassino']);
  }
  ...
  viewCASSINO(element) {
    ...
    this.router.navigate(['/main/academic-depart/counsellors/bhbn/counsellors-cassino/view-cassino'],{queryParams:{id:element.id}})
    // if(this.router.url.includes('main/academic-depart'))
  ...
  sortData(sort: Sort){
    ...
    const datalist = this.Cassino.slice();
    if (!sort.active || sort.direction === '') {
      this.Cassino = datalist;
      return;
    }
    this.Cassino = datalist.sort((a: any, b: any) => {
    ...
    this.dataSource = new MatTableDataSource(this.Cassino);
    this.dataSource.paginator = this.paginator;
    if (this.dataSource.paginator) {
      this.dataSource.paginator.firstPage();
    }
