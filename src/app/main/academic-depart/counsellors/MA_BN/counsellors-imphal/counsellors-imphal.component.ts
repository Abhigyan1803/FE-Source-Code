...
@Component({
  ...
  templateUrl: './counsellors-imphal.component.html',
  styleUrls: ['./counsellors-imphal.component.scss']
})
export class CounsellorsImphalComponent implements OnInit {
...
console.log(res,"=================");
  ...
  sortData(sort: Sort){
    ...
    const datalist = this.Imphal.slice();
    if (!sort.active || sort.direction === '') {
      this.Imphal = datalist;
      return;
    }
    this.Imphal = datalist.sort((a: any, b: any) => {
    ...
    this.dataSource = new MatTableDataSource(this.Imphal);
    this.dataSource.paginator = this.paginator;
    if (this.dataSource.paginator) {
      this.dataSource.paginator.firstPage();
    }
