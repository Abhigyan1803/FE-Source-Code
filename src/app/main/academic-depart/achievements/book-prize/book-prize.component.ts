...
@Component({
  selector: 'ms-book-prize',
  templateUrl: './book-prize.component.html',
  styleUrls: ['./book-prize.component.scss']
})
export class BookPrizeComponent implements OnInit {
  ...
  constructor(private router: Router, private adminservice: AdminService, private spinner:NgxSpinnerService,
    ...
    getAchievements(ACHIEVEMENT){
      this.spinner.show();
    this.adminservice.getACHIEVEMENTLIST(ACHIEVEMENT,2).subscribe(res =>{  
      console.log(res);
    ...
    addGC() {
      this.router.navigate(['main/academic-depart/achievements/book/add-book']);
    }
    ...
    viewGC(element) {
      this.router.navigate(['main/academic-depart/achievements/book/view-book'],{queryParams:{id:element.id}})  
    }
    sortData(sort: Sort){
