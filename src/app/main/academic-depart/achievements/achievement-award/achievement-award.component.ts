...
@Component({
  selector: 'ms-achievement-award',
  templateUrl: './achievement-award.component.html',
  styleUrls: ['./achievement-award.component.scss']
})
export class AchievementAwardComponent implements OnInit {
  ...
  constructor(private router: Router, private adminservice: AdminService, private spinner:NgxSpinnerService,
    ...
    addGC() {
      this.router.navigate(['main/academic-depart/achievements/awards/add-award']);
    }
    ...
    viewGC(element) {
      this.router.navigate(['main/academic-depart/achievements/awards/view-award'],{queryParams:{id:element.id}})  
    }
    sortData(sort: Sort){
