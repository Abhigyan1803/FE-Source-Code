...
@Component({
  selector: 'ms-hindi-cell',
  templateUrl: './hindi-cell.component.html',
  styleUrls: ['./hindi-cell.component.scss']
})
export class HindiCellComponent implements OnInit {
  ...
  ngAfterViewInit() {
    this.getAchievements('INSTRUCTION','HINDI')
  }

  getAchievements(INSTRUCTION,HINDI){
    this.spinner.show();
  this.adminservice.getClubs(INSTRUCTION,HINDI,2).subscribe(res =>{  
    console.log(res);
  ...
  addDay() {
    this.router.navigate(['/main/academic-depart/general/hindi/add-hindi']);
  }
  ...
  viewGC(element) {
    this.router.navigate(['main/academic-depart/general/hindi/view-hindi'],{queryParams:{id:element.id}})  
  
    if(this.router.url.includes('main/GS-Branch'))
    this.router.navigate(['main/gs-branch/stats/stats/poc/view-poc'],{queryParams:{id:element.id}})
